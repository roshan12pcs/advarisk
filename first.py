...
response1 = requests.post('https://epanjiyan.rajasthan.gov.in/e-search-page.aspx', headers=headers, data=updated_data)
...
response_new = requests.post('https://epanjiyan.rajasthan.gov.in/e-search-page.aspx', headers=headers, data=updated_data)
...
with open("VIEW.txt", "w", encoding="utf-8") as file:
    file.write(view_state_encoded)

with open("EVENT.txt", "w", encoding="utf-8") as file:
    file.write(even_id_encoded)
